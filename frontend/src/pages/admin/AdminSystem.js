...
import { Server, Database, Shield, Activity, HardDrive, Cpu } from 'lucide-react';
import { Progress } from '@/components/ui/progress';

const AdminSystem = ({ user }) => {
  return (
    <div className="p-8" data-testid="admin-system-page">
      <h1 className="text-4xl font-bold text-white mb-8" style={{fontFamily: 'Work Sans'}}>System Management</h1>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <div className="bg-slate-900/50 rounded-xl border border-slate-800 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-semibold text-white" style={{fontFamily: 'Work Sans'}}>Server Status</h2>
          </div>
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-800 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-semibold text-white" style={{fontFamily: 'Work Sans'}}>Database</h2>
          </div>
          <div className="space-y-3">
            <div>
              <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="px-3 py-1 rounded-full text-xs font-medium bg-emerald-500/10 text-emerald-400">Healthy</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-800 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-semibold text-white" style={{fontFamily: 'Work Sans'}}>Security</h2>
          </div>
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-slate-300 text-sm">SSL Certificate</span>
              <span className="px-3 py-1 rounded-full text-xs font-medium bg-emerald-500/10 text-emerald-400">Valid</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-slate-300 text-sm">Firewall</span>
              <span className="px-3 py-1 rounded-full text-xs font-medium bg-emerald-500/10 text-emerald-400">Active</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-900/50 rounded-xl border border-slate-800 p-6 mb-8">
        <h2 className="text-2xl font-semibold text-white mb-6" style={{fontFamily: 'Work Sans'}}>Services</h2>
        <div className="grid md:grid-cols-2 gap-4">
          <div className="flex items-center justify-between p-4 bg-slate-800/50 rounded-lg border border-slate-700">
            ...
            <span className="px-3 py-1 rounded-full text-xs font-medium bg-emerald-500/10 text-emerald-400">Running</span>
          </div>
          <div className="flex items-center justify-between p-4 bg-slate-800/50 rounded-lg border border-slate-700">
            <div className="flex items-center gap-3">
      ...
      {/* Logs */}
      <div className="bg-slate-900/50 rounded-xl border border-slate-800 p-6">
        <h2 className="text-2xl font-semibold text-white mb-6" style={{fontFamily: 'Work Sans'}}>Recent System Logs</h2>
